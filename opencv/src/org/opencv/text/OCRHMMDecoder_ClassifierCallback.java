...
public class OCRHMMDecoder_ClassifierCallback {
    ...
    protected OCRHMMDecoder_ClassifierCallback(long addr) { nativeObj = addr; }

    public long getNativeObjAddr() { return nativeObj; }

    // internal usage only
    public static OCRHMMDecoder_ClassifierCallback __fromPtr__(long addr) { return new OCRHMMDecoder_ClassifierCallback(addr); }
